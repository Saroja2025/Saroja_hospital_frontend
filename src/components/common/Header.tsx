		        ...
		        <div className="app-header-content"> 
				    ...
				    <div className="col-auto">
					    <a id="sidepanel-toggler" className="sidepanel-toggler d-inline-block d-xl-none" href="#">
                            ...
                            <title>Menu</title><path stroke="currentColor" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="2" d="M4 7h22M4 15h22M4 23h22"></path></svg>
					    </a>
				    </div>
		            ...
		            <div className="app-search-box col">
		                {/* <form className="app-search-form">   
							...
							<button type="submit" className="btn search-btn bg-hospital" value="Search"><i className="fa-solid fa-magnifying-glass"></i></button> 
				        </form> */}
		            </div>
