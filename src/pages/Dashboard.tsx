					...
					<div className="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
						<div className="inner">
							<div className="app-card-body p-3 p-lg-4">
								<h3 className="mb-3">🩺 Welcome to Saroja Hospital, Prayagraj 🏥</h3>
								<div className="row gx-5 gy-3">
									<div className="col-12 col-lg-9">
										<div>
											Now healthcare services are even closer to you!<br /><br />
											<strong>👨‍⚕️ Dr. Pramakar Upadhyay</strong> (M.B.B.S., M.S., FALS, Endoscopist)<br />
											<strong>👩‍⚕️ Dr. Nikita Tiwari</strong> (M.B.B.S., M.D. – Physician & Chest Specialist)<br /><br />
										</div>
									</div>
									...
									<div className="item p-3">
										<div className="row align-items-center">
											<div className="col">
												...
												<div className="progress">
													<div className="progress-bar bg-success" role="progressbar" style={{ width: '34%' }}
									...
									<div className="item p-3">
										<div className="row align-items-center">
											<div className="col">
												...
												<div className="progress">
													<div className="progress-bar bg-success" role="progressbar" style={{ width: '68%' }}
			...
			{/* <footer className="app-footer">
				<div className="container text-center py-3">
					<small className="copyright">
						Designed by <a className="app-link" href="#" target="_blank">Developer</a></small>
