            ...
            <div className="col-auto">
              <div className="page-utilities">
                <div className="row g-2 justify-content-start justify-content-md-end align-items-center">
                  ...
                  <div className="col-auto">
                    <a className="btn bg-hospital" href="#">
                      <svg
                        width="1em"
                        height="1em"
                        viewBox="0 0 16 16"
          ...
          <div className="row g-4">
              ...
              <div className="app-card app-card-doc shadow-sm h-100">
                <div className="app-card-thumb-holder p-3">
                  <span className="icon-holder">
                    <i className="fas fa-file-alt text-file"></i>
                  </span>
                ...
                <div className="app-card-body p-3 has-card-actions">
                  ...
                  <div className="app-doc-meta">
                    <ul className="list-unstyled mb-0">
                      ...
                      <li>
                        <span className="text-muted">Uploaded:</span> 3 mins ago
                      </li>
                    </ul>
                  </div>
                ...
                <div className="app-card-body p-3 has-card-actions">
                  ...
                  <div className="app-doc-meta">
                    <ul className="list-unstyled mb-0">
                      ...
                      <li>
                        <span className="text-muted">Edited:</span> 2 weeks ago
                      </li>
                    </ul>
                  </div>
            ...
            <div className="col-6 col-md-4 col-xl-3 col-xxl-2">
              <div className="app-card app-card-doc shadow-sm h-100">
                <div className="app-card-thumb-holder p-3">
                  <span className="icon-holder">
                    <i className="fas fa-file-video video-file"></i>
                  </span>
                  <a className="app-card-link-mask" href="#file-link"></a>
                </div>
                <div className="app-card-body p-3 has-card-actions">
                ...
                <div className="app-card-body p-3 has-card-actions">
                  ...
                  <div className="app-doc-meta">
                    <ul className="list-unstyled mb-0">
                      ...
                      <li>
                        <span className="text-muted">Edited:</span> 3 weeks ago
                      </li>
                    </ul>
                  </div>
                ...
                <div className="app-card-body p-3 has-card-actions">
                  ...
                  <div className="app-doc-meta">
                    <ul className="list-unstyled mb-0">
                      ...
                      <li>
                        <span className="text-muted">Edited:</span> 1 month ago
                      </li>
                    </ul>
                  </div>
                ...
                <div className="app-card-body p-3 has-card-actions">
                  ...
                  <div className="app-doc-meta">
                    <ul className="list-unstyled mb-0">
                      ...
                      <li>
                        <span className="text-muted">Edited:</span> 2 months ago
                      </li>
                    </ul>
                  </div>
                ...
                <div className="app-card-body p-3 has-card-actions">
                  ...
                  <div className="app-doc-meta">
                    <ul className="list-unstyled mb-0">
                      ...
                      <li>
                        <span className="text-muted">Opened:</span> 3 months ago
                      </li>
                    </ul>
                  </div>
