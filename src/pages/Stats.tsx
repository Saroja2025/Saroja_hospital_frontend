    ...
    <div className="app-wrapper">
      <div className="app-content pt-3 p-md-3 p-lg-4">
        <div className="container-xl">
          <h1 className="app-page-title">Stats</h1>
                ...
                <div className="row gx-5 gy-3">
                  <div className="col-12 col-lg-9">
                    <div>
                      ...
                      to create charts for your app. To configure the charts on
                      this page you can edit the relevant JavaScript file:{" "}
                      <code>assets/js/charts-demo.js</code>{" "}
                    </div>
                  </div>
                  <div className="col-12 col-lg-3">
                    <a
                      className="btn bg-hospital"
